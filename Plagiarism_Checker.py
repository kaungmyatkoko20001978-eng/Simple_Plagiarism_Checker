def plagiarism_check(filename1, filename2):
    ...
    sorted_with_freq2 = sorted(dct2.items(), key = lambda x: x[1], reverse = True) # I tried to use lambda here as key, x[1] means to look inside the second itemof the tuple which is the frequency value
